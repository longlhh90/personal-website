...
describe('Service Tests', () => {
  describe('Me routing resolve service', () => {
    let mockRouter: Router;
    let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
    let routingResolveService: MeRoutingResolveService;
    let service: MeService;
    let resultMe: IMe | undefined;
    ...
    beforeEach(() => {
      ...
      routingResolveService = TestBed.inject(MeRoutingResolveService);
    ...
    describe('resolve', () => {
      ...
      it('should return new IMe if id is not provided', () => {
        ...
        expect(resultMe).toEqual(new Me());
      });
