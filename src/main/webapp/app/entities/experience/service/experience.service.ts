...
export class ExperienceService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/experiences');
  ...
  update(experience: IExperience): Observable<EntityResponseType> {
    return this.http.put<IExperience>(`${this.resourceUrl}/${getExperienceIdentifier(experience) as string}`, experience, {
      observe: 'response',
    });
  }

  partialUpdate(experience: IExperience): Observable<EntityResponseType> {
    return this.http.patch<IExperience>(`${this.resourceUrl}/${getExperienceIdentifier(experience) as string}`, experience, {
      observe: 'response',
    });
  }
